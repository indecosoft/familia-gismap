...
import com.example.ovidiupodina.emotion.Config;
import com.example.ovidiupodina.emotion.Geofancing;
...
public class Storage {
    ...
    public void setConfig(int dataInt, int idClient, int pulseInt, int locInt, int valMaxPulse, int valMinPulse, int idPersAsisoc) {
