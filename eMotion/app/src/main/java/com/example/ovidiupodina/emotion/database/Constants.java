...
public class Constants {
    ...
    public static final String ANDROID_CHANNEL_NAME = "ANDROID_CHANNEL_NAME";

//    dev
    private static final String type = "dev"; // ""
    private static final String BASE_URL = "https://gis" + type + ".indecosoft.net/devices";
    ...
    public static final int RES_CONFIG_DATA = 105;
    public static final int RES_SEND_DATA = 104;
